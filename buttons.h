...
ButtonStruct buttons[NUM_BUTTONS] = {
  ...
  { {},  29, BTN_ACTION_NONE,      BTN_ACTION_NONE, TG_ENVELOPE_MENU,    BTN_ACTION_NONE, BTN_ACTION_NONE,           BTN_ACTION_NONE, TG_ENVELOPE_MENU,    TG_ENVELOPE_MENU,    BTN_ACTION_NONE, TG_ENVELOPE_MENU,    TG_ENVELOPE_MENU,    BTN_ACTION_NONE },
  { {},  26, TG_LFO1_WAVE,         BTN_ACTION_NONE, TG_LFO_MENU,         BTN_ACTION_NONE, BTN_ACTION_NONE,           BTN_ACTION_NONE, TG_ENABLE_ADSR3,     TG_LFO_MENU,         BTN_ACTION_NONE, TG_LFO_MENU,         BACK,                EXIT },
  ...
  { {},  20, SELECT_ENC_ACTION,    BTN_ACTION_NONE, TG_CALIBRATION_MENU, BTN_ACTION_NONE, SELECT_ENC_ACTION,         BTN_ACTION_NONE, TG_CALIBRATION_MENU, SELECT_ENC_ACTION,   BTN_ACTION_NONE, TG_CALIBRATION_MENU, TG_CALIBRATION_MENU, BTN_ACTION_NONE },
