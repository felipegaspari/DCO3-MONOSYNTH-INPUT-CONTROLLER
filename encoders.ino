...
static EncoderParamBinding encoderParamBindings[] = {
    ...
    {ACTION_ADSR1_MODE, &ADSR1Mode, ENC_VAL_I8, 0, 2, 1, 0, ParamId::PARAM_ADSR1_MODE, 0},
    {ACTION_ADSR2_MODE, &ADSR2Mode, ENC_VAL_I8, 0, 2, 1, 0, ParamId::PARAM_ADSR2_MODE, 0},
    {ACTION_ADSR3_MODE, &ADSR3Mode, ENC_VAL_I8, 0, 2, 1, 0, ParamId::PARAM_ADSR3_MODE, 0},
    {ACTION_ADSR1_RESTART, (void*)&ADSR1Restart, ENC_VAL_I8, 0, 1, 1, 0, ParamId::PARAM_ADSR1_RESTART, 0},
