...
enum EncoderAction {
  ...
  ACTION_ADSR2_MODE,
  ACTION_ADSR3_MODE,
  ACTION_ADSR1_RESTART,
  ACTION_ADSR2_RESTART,
  ACTION_ADSR3_RESTART,

  ACTION_VOICE_MODE,
  ACTION_VOICE_ALLOC_MODE,
  ACTION_SYNC_MODE,
  ACTION_SOFT_SYNC,
  ACTION_PORTAMENTO_MODE,
  ACTION_SUBOSC_DIVIDE,

  ACTION_LFO1_WAVEFORM,
  ACTION_LFO2_WAVEFORM,
  ACTION_LFO1_to_OSC1,         
  ACTION_LFO1_to_OSC2,         
